...
//     let num2=+box2.value;
//     let result=num1*num2;
//     document.querySelector("#root").innerHTML=`multiplication result=${result}`
// }
...
//     let num2=+box2.value;
//     let result=num1/num2;
//     document.querySelector("#root").innerHTML=`division result=${result}`;
// }
...
function evaluateExp(event){
    ...
    document.querySelector("#root").innerHTML=`result=${result}`
}